...
[Magento 2 Layered Navigation](https://www.ulmod.com/magento-2-layered-navigation-extension.html) is a Magento 2 extension that allows your shoppers to search through the store catalog and get their products in the shortest time.

With Magento 2 Layered Navigation, you can enhance the default layered navigation with a bunch of great features  such as AJAX loading, multiple filters select, horizontal & vertical navigation, extra filters options, and more


<a href="https://www.ulmod.com/magento-2-layered-navigation-extension.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Ajax Loading page for quick filtering;
* Vertical and horizontal layered navigations;
* Support multi and single filters select
* Auto "Scroll To Top" after filtering;
* Ratings, ‘New’, ‘On Sale’, ‘In Stock’ extra filters supported;
* Sticky layered navigation on the sidebar during vertical page scrolling;
* Manually reload after each single & multi-select;
* Pre-select filters to display expanded by default;
* Support price slider, 6 sliders types supported;
* Product count, on each filter option;
* Search box, and view more on each filter;
* Support multi-stores
* Mobile-friendly

<img src="https://www.ulmod.com/media/ulmod/product_content/um-ln-feature1.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/um-ln-feature2.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/um-ln-feature44.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/um-ln-feature6.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/um-ln-feature99.png">
